...
export interface UseFetchReturn<T> {
    ...
    text<T = string>(): UseFetchReturn<T> & PromiseLike<UseFetchReturn<T>>
    blob<BL = Blob>(): UseFetchReturn<BL> & PromiseLike<UseFetchReturn<BL>>
    arrayBuffer<BUFFER = ArrayBuffer>(): UseFetchReturn<BUFFER> & PromiseLike<UseFetchReturn<BUFFER>>
    formData<FORM_DATA = FormData>(): UseFetchReturn<FORM_DATA> & PromiseLike<UseFetchReturn<FORM_DATA>>
}
